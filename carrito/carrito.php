...
<table width="288" border="0">
 ...
 ?>  
  <tr>
    ...
    <td bgcolor="#FFFFCC">
    <form action="" method="post" name="actulizo">
    ...
    <input name="" type="image" src="../iconos/ic_autorenew_black_24dp_1x.png" />
    </form></td>
    <?php 
    ...
    <td bgcolor="#FFFFCC"><form action="" method="post">
    	...
    	<input name="" type="image" src="../iconos/ic_close_black_24dp_1x.png" />
    </form></td>
  </tr>
  <?php
			}
